...
export const user_test = {
  permissions: [
    ...
    GLOBAL_PERMISSIONS.READ_MALADIES,
    GLOBAL_PERMISSIONS.READ_CRISES,
    GLOBAL_PERMISSIONS.READ_MEDICAMENTS,
    GLOBAL_PERMISSIONS.READ_TYPE_PERSONNELS,
    GLOBAL_PERMISSIONS.READ_GAP,
  ],
};
